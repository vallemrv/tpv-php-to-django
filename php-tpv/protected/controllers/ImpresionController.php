...
class ImpresionController extends CController {
    ...
    public function actionPreImprimir(){
      ...
      if (Yii::app()->params["django_print"]){
          ComDjango::PreImprimirTicket(Yii::app()->params["urldj"], $idm);
      }else{
    ...
    function actionTicket(){
        $id = $_POST["id"];
        if (Yii::app()->params["django_print"]){
            ComDjango::ImprimirTicket(Yii::app()->params["urldj"], $id);
        }else{
    ...
    function actionAbrirCajon(){
      if (Yii::app()->params["django_print"]){
          ComDjango::AbrirCajon(Yii::app()->params["urldj"]);
      }else{
          $rutFicheros = Yii::app()->params["dirPrint"].  uniqid();
          $nombreImpresora = Receptores::model("Receptores")->find("Nombre='Ticket'")->nomImp;
    ...
    function actionReenviarLinea(){
         ...
         $nombre = $_POST["Nombre"];
         if (Yii::app()->params["django_print"]){
             ComDjango::ReeviarLinea(Yii::app()->params["urldj"], $idp, $id, $nombre);
         }else{
