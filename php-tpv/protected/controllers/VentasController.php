...
# @Filename: VentasController.php
# @Last modified by:   valle
# @Last modified time: 14-Aug-2017
...
class VentasController extends CController{
    ...
    public function actionVentaBruta(){
      $año = $_GET["año"];
      $mes = isset($_GET["mes"]) ? $_GET["mes"] : "%";
      $dia = isset($_GET["dia"]) ? $_GET["dia"] : "%";
      $exit = array();
      $exit[] = array("año"=>$año, "mes"=>$mes, "dia"=>$dia,
                      "importe"=>$this->getVentas($mes, $año, $dia));
      echo json_encode($exit);
    }


    public function actionComparativaAños(){
      $año = $_GET["año"];
      $años =  array($año, $año-1, $año-2);
      $meses = array("01",  "02", "03",  "04", "05",  "06", "07", "08",
               "09", "10", "11", "12");
      $exit = array();
      foreach ($años as $a) {
    ...
    function getVentas($mes, $año, $dia="%"){
