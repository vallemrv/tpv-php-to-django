# Generated by Django 2.1.2 on 2018-10-10 14:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isub_pago', models.IntegerField(db_column='IDSub_pago')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tecla_id', models.IntegerField(db_column='IDTecla')),
        ...
        migrations.AddField(
            model_name='mesaszona',
            name='zona',
            field=models.ForeignKey(db_column='IDZona', on_delete=django.db.models.deletion.CASCADE, to='gestion.Zonas'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='usurario',
            field=models.ForeignKey(db_column='IDUsr', on_delete=django.db.models.deletion.CASCADE, to='gestion.Usuarios'),
        ),
        migrations.AddField(
            model_name='historialnulos',
            name='lineapedido',
            field=models.ForeignKey(db_column='IDLPedido', on_delete=django.db.models.deletion.CASCADE, to='gestion.Lineaspedido'),
        ),
        migrations.AddField(
            model_name='familias',
            name='receptor',
